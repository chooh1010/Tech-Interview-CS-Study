...
<li> BCNF가 무엇인지 설명하고, 제3정규형과 어떤 차이가 있는지 예시를 들어 설명해 주세요.</li>
<li> 제3정규형을 만족하는데도 BCNF를 만족하지 못하는 테이블이 있을 수 있나요? 있다면 예시를 들어주세요.</li>
<li> BCNF까지 정규화하면 모든 이상현상이 사라지나요? 제4, 제5정규형은 어떤 문제를 다루나요?</li>
