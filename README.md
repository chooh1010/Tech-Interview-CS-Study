...
- 총 **대질문 114개** + **손코딩 15문항**
- 손코딩은 **워밍업 12조각 + 응용 13문항**으로 재편했습니다 (원본 1·2번이 여러 구현을 한 문항에 묶고 있어 12주로 쪼갰습니다)
- 주당 평균 **9\~10개 질문 + 워밍업 1조각 + 응용 1\~2문항** (Week 11만 12개)
...
| 주차 | 주제 | 학습 범위 | 질문 | 워밍업 구현 | 응용 |
|:--:|---|---|:--:|---|:--:|
| [Week 01](weeks/week-01.md) | 자료구조 기초 | 자료구조 1~8 · 개발상식 1 | 9 | LinkedList | 1 |
| [Week 02](weeks/week-02.md) | 알고리즘과 그래프 | 자료구조·알고리즘 9~16 · 개발상식 1 | 9 | 버블·선택·삽입 정렬 | 1 |
| [Week 03](weeks/week-03.md) | OS I — 커널과 프로세스 | 운영체제 1~7, 10 · 개발상식 1 | 9 | Stack | 1 |
| [Week 04](weeks/week-04.md) | OS II — 동시성과 동기화 | 운영체제 8, 9, 11~13, 20, 23 · 개발상식 2 | 9 | 병합 정렬 | 1 |
| [Week 05](weeks/week-05.md) | OS III — 메모리와 파일 시스템 | 운영체제 14~19, 21, 22 · 개발상식 1 | 9 | 이진 탐색 트리 | 1 |
| [Week 06](weeks/week-06.md) | Network I — HTTP와 웹 | 네트워크 1~6, 16 · 개발상식 2 | 9 | 퀵 정렬 | 1 |
| [Week 07](weeks/week-07.md) | Network II — 전송·네트워크 계층 | 네트워크 7, 10~12, 17, 19, 20 · 개발상식 2 | 9 | Heap | 1 |
| [Week 08](weeks/week-08.md) | Network III — 인터넷 인프라와 보안 | 네트워크 8, 9, 13~15, 18, 21 · 개발상식 3 | 10 | 힙 정렬 | 1 |
| [Week 09](weeks/week-09.md) | DB I — 모델링과 트랜잭션 | 데이터베이스 1~4, 7, 8, 13 · 개발상식 2 | 9 | HashTable | 1 |
| [Week 10](weeks/week-10.md) | DB II — 인덱스와 성능·운영 | 데이터베이스 5, 6, 9\~12, 14\~16 · 개발상식 1 | 10 | 계수·기수 정렬 | 2 |
| [Week 11](weeks/week-11.md) | Java 핵심 | Java 1~12 | 12 | Queue (원형 큐·Deque) | 1 |
| [Week 12](weeks/week-12.md) | Spring 핵심 | Spring 13~21 · 개발상식 1 | 10 | 정렬 총정리·Tim sort | 1 |
| | | **합계** | **114** | **12** | **13** |
...
- 손코딩은 몰아서 하면 감이 끊기므로 **매주 꾸준히** 배치했습니다. 다만 원본 1번(각종 정렬)·2번(각종 자료구조)은 한 문항 안에 구현이 5~6개씩 들어 있어 그 두 주만 부담이 3~4배였습니다. 그래서 **자료구조 6조각 + 정렬 6조각으로 쪼개 12주에 1개씩 배치**하고, 나머지 응용 13문항과 분리했습니다
- 워밍업 조각은 **선행 관계**를 지켰습니다. Heap(Week 07) → 힙 정렬(Week 08) 순서이고, 병합 정렬(Week 04)은 같은 주 응용 문항인 *정렬된 두 LinkedList 병합*과, HashTable(Week 09)은 *중복 제거 + 정렬*과 짝이 됩니다. 질문이 많은 Week 11·12에는 가벼운 조각을 뒀습니다
...
| **Part 3. 손코딩** | **워밍업** (자료구조·정렬 구현 1조각, 10분) + **응용 문항** (1~2개) + 복잡도 기록란 |
| **회고** | 미해결 질문, 약점 주제, 참고 자료 |

> 워밍업 조각에는 **구현 범위** 한 줄이 붙어 있습니다. "어디까지 구현할지"가 사람마다 달라지면 비교가 안 되므로, 최소 요구 연산을 못 박아 뒀습니다. 응용 문항은 반대로 열린 문제라 힌트가 없습니다.
...
- [06. 손코딩 (연습 문항)](06-ALGORITHM.md) — 15문항 (원본 그대로. 1·2번은 주차 파일에서 12조각으로 나눠 진행합니다)
